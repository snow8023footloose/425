...
export function cashier60(orderMsg,printerName,number) {
  ...
  LODOP.ADD_PRINT_TEXT(hasHeight, 0, 80, 20, orderMsg.voucherName);
  ...
  LODOP.ADD_PRINT_TEXT(hasHeight, 0, 80, 20, "优惠金额");
  LODOP.ADD_PRINT_TEXT(hasHeight, 125, 70, 20,   orderMsg.transferMoney);
  hasHeight += 20;

  LODOP.ADD_PRINT_LINE(hasHeight, 0, hasHeight, 259, 2, 0.5);
  LODOP.ADD_PRINT_TEXT(hasHeight, 0, 120, 20, "总计（实付）");
  LODOP.SET_PRINT_STYLEA(0, "FontSize", 11);
  LODOP.ADD_PRINT_TEXT(hasHeight, 125, 70, 20,   orderMsg.realPay);
  LODOP.SET_PRINT_STYLEA(0, "FontSize", 11);
...
export function cashier80(orderMsg,printerName,number) {
  ...
  LODOP.ADD_PRINT_TEXT(hasHeight, 0, 80, 20, "优惠金额");
  LODOP.ADD_PRINT_TEXT(hasHeight, 200, 70, 20,   orderMsg.transferMoney);
  hasHeight += 20;

  LODOP.ADD_PRINT_LINE(hasHeight, 0, hasHeight, 259, 2, 0.5);
  LODOP.ADD_PRINT_TEXT(hasHeight, 0, 120, 20, "总计（实付）");
  LODOP.SET_PRINT_STYLEA(0, "FontSize", 11);
  LODOP.ADD_PRINT_TEXT(hasHeight, 200, 70, 20,   orderMsg.realPay);
  LODOP.SET_PRINT_STYLEA(0, "FontSize", 11);
